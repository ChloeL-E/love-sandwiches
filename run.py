...
def validate_data(values):
    ...
    Raises ValueError if strings cannot be convertes into int, 
...
""" 
commented out 2 functions to demo refactoring process
...
def update_surplus_worksheet(data):
    ...
    Updates the surplus worksheet, adds new row with the surplus 
    list data provided.
...
def calculate_stock_data(data):
    ...
    for column in data:
        ...
        average = sum(int_column) / len(int_column) #finding the average
